  ...
  return (
    <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
        <Card className="sm:col-span-2 bg-white" x-chunk="dashboard-05-chunk-0">
        ...
        <Card className="bg-white text-black" x-chunk="dashboard-05-chunk-1">
        ...
        <Card className="bg-white text-black" x-chunk="dashboard-05-chunk-2">
          <CardHeader className="pb-2">
            <CardDescription className="w-full flex items-center justify-between">
              Past Enrollments
